                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header pb-0">
                            <h6 class="float-start">Cadastro de Categorias</h6>
                            ...
                            <form id="formCadastro">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 form-group">
                                        ...
                                        <input type="file" class="form-control" id="Imagem" name="Imagem" accept="image/*" maxlength="255" <?= isset($_GET['IDCategoria']) ? '' : 'required' ?>>
                                    </div>
                                    <div class="col-12 col-md-6 form-group">
                                        <label for="Banner">Banner</label>
                                        <input type="file" class="form-control" id="Banner" name="Banner" accept="image/*" maxlength="255" <?= isset($_GET['IDCategoria']) ? '' : 'required' ?>>
                                    </div>
                                </div>
                                <div class="col-md-12">
