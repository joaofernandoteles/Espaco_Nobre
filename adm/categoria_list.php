                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Capa</th>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex px-3 py-1">
                                                        <img style="width:220px ;" src="assets/img/categoria/capa/<?= $res->Imagem ?>" alt="">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-3 py-1">
                                                        <img style="width:220px ;" src="assets/img/categoria/banner/<?= $res->Banner ?>" alt="">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="d-flex px-3 py-1">
